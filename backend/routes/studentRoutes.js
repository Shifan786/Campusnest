...
const { getGrades, getAttendance, getNotices, getDashboardStats, getAvailableCourses, submitEnrollment, getEnrollmentStatus } = require('../controllers/studentController');
